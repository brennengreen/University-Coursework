...
%{
EDGE CASE TESTING
Given the value zero as an input, the program behaves by reporting infinite
    numbers due to zero division
    
Given negative numbers, the program behaves unpredictably reporting numbers
